  ...
  return (
    <section className="bg-white pb-10">
      <div className="container mx-auto">
        ...
        <hr className="mb-12 border-2 bg-[#6C757D] w-[1550px]" />
        {
          currentCarouselItem.title == "Cigar Room"?( <div className='flex justify-center gap-[100px] '>
          <div className=''>
        ...
        {
          currentCarouselItem.title === "Kitchen Room"?( <div className='flex justify-center gap-[100px] '>
          <div className=''>
            <img className='h-[800px]' src={car1} alt="" />
          </div>
          <div className='flex flex-col justify-between w-fit' >
        ...
        {
          currentCarouselItem.title == "Cheese Room"?( <div className='flex justify-center gap-[100px] '>
          <div className=''>
            <img className='h-[800px]' src={car1} alt="" />
          </div>
          <div className='flex flex-col justify-between w-fit' >
         ...
         {
          currentCarouselItem.title == "Dining Room"?( <div className='flex justify-center gap-[100px] '>
          <div className=''>
            <img className='h-[800px]' src={car1} alt="" />
          </div>
          <div className='flex flex-col justify-between w-fit' >
