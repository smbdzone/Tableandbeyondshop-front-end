...
const RightContainer = () => {
    ...
    return (
        <div className='w-1/2 flex flex-col  items-center '>
            ...
            <p className='subheading'>Dont have an account yet?<span className='text-[#8D7C3B]'><u>Register</u></span></p>
            <div className='flex flex-col gap-10 relative h-[130px]'>
                <Input type='text' placeholder='Enter your Email' />
                <Input type='password' placeholder='Enter your Password' />
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="17" viewBox="0 0 25 17" fill="none" className='absolute top-[120px] right-[20px]'>
            ...
            <div className='flex flex-row gap-5 mt-[4rem]'style={{
                justifyContent: "space-between",
                width: "536px",
                alignItems:"center",
                height:"64px",
            }}>
                <div className='flex flex-row justify-center  items-center w-[200px] h-[54px] shrink-0 bg-[#fff] rounded-[5px]  btn ml-[20px]' >
                    <img src={google} alt="" className='h-[28.108px] w-[28.108px]' />
                    <p className='logotext'>Google</p>
                </div>
                <div className='flex flex-row justify-center  items-center w-[200px] h-[54px] shrink-0 bg-[#fff] rounded-[5px]  btn mr-[20px]' >
                    <img src={facebook} alt="" className='h-[28px] w-[15px]' />
                    <p className='logotext'>Facebook</p>
                </div>
            </div>
            <div className='flex justify-around gap-[30px] mt-[2rem]'>
                <p>Order Tracking</p>
                <p>Easy Return</p>
                <p>Support</p>
            </div>
